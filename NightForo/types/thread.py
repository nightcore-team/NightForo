...
class Thread(BaseModel):
    ...
    visitor_post_count: (
        int  # If accessing as a user, the number of posts they have made in this thread
    )
    ...
    tags: List[str]
    prefix: str  # Present if this thread has a prefix. Printable name of the prefix.
    can_edit: bool
    can_edit_tags: bool
    can_reply: bool
